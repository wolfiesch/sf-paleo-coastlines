...
| [USGS 1 m SF Bay DEM source footprints](https://www.sciencebase.gov/catalog/item/607df19dd34e8564d67e3af3) | highest | Adds survey-level provenance for the Bay DEM: agency, year, sensor type, datum, resolution, and interpolation status. This tells us where the future 1 m Bay surface is most trustworthy. | Run `pnpm paleo-coastlines:bay-source-footprints`. Central Bay is currently included; North/South are recorded as skipped until ScienceBase returns complete shapefile packages. |
