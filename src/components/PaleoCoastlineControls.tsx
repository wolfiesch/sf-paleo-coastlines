...
function terrainSummary(slice: PaleoTimeSlice): string | null {
  ...
  return `${terrains.length} terrain surfaces, drawn from broad support grids up to sharper local survey patches: NOAA CRM/CUDEM Bay-to-coast coverage, NOAA OCM 1 m Area A Bay-floor mosaic, Central Bay source-survey tiles, NOAA BAG Golden Gate and Farallon-region survey patches, USGS/CSMP 2 m coastal bathymetry blocks, Farallon Escarpment/Rittenburg Bank offshore multibeam patches, and DS684 Golden Gate detail.`;
}
