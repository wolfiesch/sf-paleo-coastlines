...
BEST_AVAILABLE_SEAM_BLEND_TARGETS = [
    ...
    {
        "categories": ["CRM fallback", "USGS CoNED broad"],
        "lon": -123.127923,
        "lat": 37.347048,
        "reason": "Post-resample local seam audit measured a 107.667 m 95% height step.",
    },
    {
        "categories": ["NOAA multibeam", "USGS CoNED focus"],
        "lon": -123.244154,
        "lat": 37.70538,
        "reason": "Post-resample local seam audit measured a 43.809 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "NOAA multibeam"],
        "lon": -123.446534,
        "lat": 37.79462,
        "reason": "Post-resample local seam audit measured a 34.836 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS nearshore"],
        "lon": -122.474976,
        "lat": 37.2814,
        "reason": "Post-resample local seam audit measured a 30.398 m 95% height step.",
    },
    {
        "categories": ["CRM fallback", "USGS CoNED focus"],
        "lon": -123.294407,
        "lat": 37.485867,
        "reason": "Post-resample local seam audit measured a 25.3 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS Bay DEM"],
        "lon": -122.117736,
        "lat": 37.533736,
        "reason": "Post-resample local seam audit measured a 24.715 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS Bay DEM"],
        "lon": -122.11295,
        "lat": 37.487235,
        "reason": "Post-resample local seam audit measured a 24.64 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS nearshore"],
        "lon": -122.410707,
        "lat": 37.291657,
        "reason": "Post-resample local seam audit measured a 24.333 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS Bay DEM"],
        "lon": -121.993983,
        "lat": 37.439366,
        "reason": "Post-resample local seam audit measured a 22.948 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS Bay DEM"],
        "lon": -122.033981,
        "lat": 37.452701,
        "reason": "Post-resample local seam audit measured a 22.76 m 95% height step.",
    },
    {
        "categories": ["CRM fallback", "USGS CoNED broad"],
        "lon": -123.210994,
        "lat": 37.347048,
        "reason": "Post-resample local seam audit measured a 22.257 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS nearshore"],
        "lon": -122.964173,
        "lat": 38.212788,
        "reason": "Post-resample local seam audit measured a 21.259 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "NOAA multibeam"],
        "lon": -123.402605,
        "lat": 37.779576,
        "reason": "Post-resample local seam audit measured a 20.825 m 95% height step.",
    },
    {
        "categories": ["CRM fallback", "USGS CoNED broad"],
        "lon": -123.293724,
        "lat": 37.356793,
        "reason": "Post-resample local seam audit measured a 20.431 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS CoNED broad"],
        "lon": -122.140982,
        "lat": 37.960109,
        "reason": "Post-resample local seam audit measured a 20.219 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS Bay DEM overview"],
        "lon": -122.106112,
        "lat": 38.052428,
        "reason": "Post-resample local seam audit measured a 20.174 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS Bay DEM overview"],
        "lon": -121.889717,
        "lat": 38.050376,
        "reason": "Post-resample local seam audit measured a 19.859 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS CoNED broad"],
        "lon": -122.795638,
        "lat": 38.153294,
        "reason": "Post-resample local seam audit measured an 18.687 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS Bay DEM overview"],
        "lon": -121.961678,
        "lat": 38.055163,
        "reason": "Post-resample local seam audit measured an 18.544 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS Bay DEM overview"],
        "lon": -122.05415,
        "lat": 38.058924,
        "reason": "Post-resample local seam audit measured a 17.576 m 95% height step.",
    },
    {
        "categories": ["CUDEM support", "USGS nearshore"],
        "lon": -122.465404,
        "lat": 37.231137,
        "reason": "Post-resample local seam audit measured a 14.677 m 95% height step.",
    },
]
